...
Diante da problemática apresentada ([Problema](problema.md)), o trabalho visa atender à demanda de tornar a rotina dos profissionais do setor de mecânica e manutenção automotiva mais prática, isentando esses profissionais da burocracia, da desordem, do descontrole e das preocupações constantes com estoque, financeiro, agendamento e outros processos manuais. Analisando esse contexto, ao automatizar esses processos manuais e repetitivos, o profissional poderá se preocupar apenas em prestar um bom serviço e atender da melhor forma os seus clientes, economizando tempo, recursos e energia.

## Objetivos Específicos

- O intuito principal deste projeto é melhorar a forma como são feitos o agendamento e o controle de clientes e demandas de uma oficina automotiva, facilitando o fluxo e a gestão do tempo. O sistema proporcionará previsibilidade para que o cliente saiba por quanto tempo sua manutenção ou melhoria será realizada, transmitindo transparência e confiança no serviço prestado. A tecnologia visa melhorar também a rotina do profissional como um todo, possibilitando uma melhor administração de suas demandas a cada dia, semana e mês.

  O agendamento poderá ser realizado pelo próprio cliente, que visualizará a disponibilidade do profissional em tempo real, ou pelo próprio profissional ou por um colaborador, como um(a) secretário(a), por exemplo. É possível utilizar ferramentas como o Kanban para tornar transparentes e claras as demandas aguardando análise, as que estão aguardando início, em progresso, pendentes e concluídas.
